...
class EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event" do
    assert_difference('Event.count') do
      post events_url, params: { event: { contact_email: @event.contact_email, contact_phone: @event.contact_phone, description: @event.description, end_time: @event.end_time, location: @event.location, name: @event.name, num_vols: @event.num_vols, start_time: @event.start_time } }
    end
