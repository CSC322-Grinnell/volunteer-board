...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { email: @welcome.email, login: @welcome.login } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { email: @welcome.email, login: @welcome.login } }
